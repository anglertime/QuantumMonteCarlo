...
global constK Box datafile sideLength max_dist_sqr max_Acut
...
dim = 3; N = 2*11^3; indicator = ones(1, N); totalSteps = 5*N;
...
%     detRatio_dense = dense_detRatio (A,u,movingParticle);
    ...
    timemcStep = tic;
    [detRatio_iter, mhat, iter] = iterative_detRatio(A, u, movingParticle, mcStep);
    detRatio = detRatio_iter;
