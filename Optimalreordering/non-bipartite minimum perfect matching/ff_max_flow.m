...
% The graph is expressed as N by N adjacency matrix. 
% N is the number of vertices in the graph, i.e., 
% "nodes_number". "source","sink" are identified by 
% the node ID. "capacity" is an N by N matrix express 
% the edge capacity. "max_flow" is output max flow found.
