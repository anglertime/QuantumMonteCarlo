...
global indicator dim reinitialize datafile1 
global array_m array_u array_detRatio

%Initialization
dim = 3; N = 1024; indicator = ones(1, N); totalSteps = 20000;
...
for mcStep = 1:totalSteps
    ...
    if (detRatio*detRatio > randNum)
        ...
        %% reordering step
        [ A, globalCount, dsum, global_cutoff, localcutoff, reord, Array_cut, Array_dsum, ParticleConfig,...
