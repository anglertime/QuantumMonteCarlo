function [ B_re, newParticle, LocalMatching, num, cutoff, localSize, Match_LocalnumNew ] = LocalReorder( B, Particle, mcStep, Match_Localnum )
...
localSize = m1;
Match_LocalnumNew = Match_Localnum;
Match_LocalnumNew(1:3, end + 1) = [mcStep; num; m1];
end
